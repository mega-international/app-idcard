...
import TabOutlet from '../views/TabOutlet.vue';
        ...
        children: [
          {
            ...
            name: 'Search',
            component: Search,
            props: (route) => ({ tab: route.query.tab || 'applications' }),
          },
          {
            path: '/favorites',
            name: 'Favorites',
        ...
        children: [
          {
            ...
            component: () => import(/* webpackChunkName: "ViewItem" */ '../views/ViewApplication.vue'),
            meta: {
              type: 'application'
            }
          },
          {
            path: '/view/technologies/:id',
            name: 'ViewTechnology',
            component: () => import(/* webpackChunkName: "ViewItem" */ '../views/ViewTechnology.vue'),
            meta: {
              type: 'technology'
            }
          }
