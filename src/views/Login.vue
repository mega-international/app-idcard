<template>
  <section class="login sm:container mx-auto px-4 lg:flex lg:flex lg:px-0">
    ...
    <section class="mt-24 mb-8 lg:w-3/5 lg:mx-auto lg:flex lg:flex-col lg:justify-center lg:items-center">
      <header class="lg:w-3/4 text-center">
        ...
        <div class="w-full mt-5 mx-auto ">
          <img class="inline-block object-contain w-8 lg:w-10 mr-4" src="@/assets/img/app-icon.png" :alt="$t('text.appName')">
